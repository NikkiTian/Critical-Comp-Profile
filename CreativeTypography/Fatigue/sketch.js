...
////i wish i can add a blurry effect
let font;
...
function setup() {
  ...
  text1 = new FatigueEffect("Fatigue", width / 2 - 60, 150);
  text2 = new FatigueEffect("Fatigue", width / 2 - 60, 310);
  text3 = new FatigueEffect("Fatigue", width / 2 - 60, 480);
}
...
class FatigueEffect {
  ...
  update3() {
    ////added "true" to clamp the value of the mappedMouse to 0-1
